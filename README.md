...
This repo contains the two files needed to complete the midterm assignment, the .qmd file and the .csv file. The files will go live at 5:30pm on Monday 20th July 2026. Please review the following instructions carefully.
...
*You are expected to complete this problem set yourself without excessive use of AI. You should use sample code from seminars and lectures, and adapt it to the questions below on your own. You may consult AI to answer general questions and/or supplement your learning, but not to complete the exercises. Markers have lots of experience reviewing student work, and they can usually tell when AI substantially completed an assignment. If we suspect you have done this, we will mark your answers accordingly.*
